...
public class LocationController {
    ...
    public ResponseEntity<?> getNearestCharger(
        ...
        List<Location> nearestChargers = (List<Location>) locationService.findNearestCharger(latitude, longitude, provider);

        if (nearestChargers.isEmpty()|| nearestChargers.equals(null)) {
